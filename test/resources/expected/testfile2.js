...
const pfWebpackOptions = require("@scope/patternfly-base/patternflyWebpackOptions");
const { merge } = require("webpack-merge");
const common = require("../../webpack.common.config");
const externalAssets = require("@scope/external-assets-base");
  ...
  return merge(common, {
    ...
    plugins: [
      new CopyPlugin([
        ...
        { from: "../../node_modules/@scope/kie-bc-editors/dist/envelope-dist", to: "./envelope" },
