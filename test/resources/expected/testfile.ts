...
import { I18n } from "@scope/i18n/dist/core/I18n";
import { WorkspaceApi } from "@scope/workspace/dist/api";
...
export function registerTestScenarioRunnerCommand(args: {
  ...
  args.context.subscriptions.push(
    vscode.commands.registerCommand(args.command, () =>
      run(args.backendProxy, args.workspaceApi, args.backendI18n)
    )
  );
}
